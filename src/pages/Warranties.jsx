  ...
  return (
    <main className="legal-page" style={{maxWidth: 900, margin: "40px auto", padding: "0 16px", lineHeight: 1.7}}>
      ...
      <p>
        ...
        shërbimet tona. Për çdo paqartësi, na shkruani: <a href="mailto:
...
info@topmobile.store</a>.
      ...
      <ol>
        <li>Na kontaktoni: <a href="mailto:
info@topmobile.store">
info@topmobile.store</a> ose WhatsApp: +383 045 407 222</li>
      ...
      <h2>Kontakt</h2>
      <p>
        Servis &amp; garanci: <a href="mailto:
info@topmobile.store">

info@topmobile.store</a> · +383 048 723 720

      </p>

      <p style={{fontSize: 13, opacity: .8, marginTop: 24}}>
